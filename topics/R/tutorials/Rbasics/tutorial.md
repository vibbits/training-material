...
![new_script](../../images/new_script.png)
...
##### Saving a script
If there are unsaved changes in a script, the name of the script will be red and followed by an asterisk. To save the script click the **Save** button: ![save_script](../../images/save_script.png)
...
To save a plot click the **Export** button: ![export_plot](../../images/export_plot.png)
...
![refresh_button](../../images/refresh_button.png)
...
![install_zip](../../images/install_zip.png "Installing packages downloaded from their source site")
...
![logic_operators](../../images/logic_operators.png)
