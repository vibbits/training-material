...
### What is DMPOnline
Have a look at the video below for a general introduction on [DMPOnline](https://dmponline.be/):
...
- find a suitable home via <a href="https://www.re3data.org/" target="\_blank">re3data.org</a>. Have a look at the video below to see how it works
...
- [Elsevier Data Search](https://data.mendeley.com/research-data/) - try out chip-seq drosophila
...
Costs Overview (/docs/01_UU_CostOverview.pdf)
